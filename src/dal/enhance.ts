...
const argsInfo = {
  ...
  DeleteManyRoleArgs: ["where", "limit"],
  ...
  UpdateManyRoleArgs: ["data", "where", "limit"],
  ...
  DeleteManyPermissionArgs: ["where", "limit"],
  ...
  UpdateManyPermissionArgs: ["data", "where", "limit"],
  ...
  DeleteManyRolePermissionsArgs: ["where", "limit"],
  ...
  UpdateManyRolePermissionsArgs: ["data", "where", "limit"],
...
const outputsInfo = {
  ...
  UpdateManyUserAndReturnOutputType: ["id", "email", "username", "password", "firstName", "lastName", "lastLogin", "isSuperuser", "isStaff", "isActive", "dateJoined", "dateOfBirth", "roleId", "Role"],
  CreateManyAndReturnRole: ["id", "name"],
  UpdateManyRoleAndReturnOutputType: ["id", "name"],
  CreateManyAndReturnPermission: ["id", "name"],
  UpdateManyPermissionAndReturnOutputType: ["id", "name"],
  CreateManyAndReturnRolePermissions: ["id", "roleId", "permissionId", "Role", "Permission"],
  UpdateManyRolePermissionsAndReturnOutputType: ["id", "roleId", "permissionId", "Role", "Permission"]
};
...
const inputsInfo = {
  ...
  RoleScalarRelationFilter: ["is", "isNot"],
  ...
  PermissionScalarRelationFilter: ["is", "isNot"],
