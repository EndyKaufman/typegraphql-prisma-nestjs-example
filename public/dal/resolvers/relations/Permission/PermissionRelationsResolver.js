...
exports.PermissionRelationsResolver = void 0;
const graphql_1 = require("@nestjs/graphql");
const Permission_1 = require("../../../models/Permission");
const RolePermissions_1 = require("../../../models/RolePermissions");
const helpers_1 = require("../../../helpers");
const DataLoader = require("dataloader");
let PermissionRelationsResolver = class PermissionRelationsResolver {
    async RolePermissions(permission, ctx, info, dataloader) {
        return await dataloader.load(permission.id);
    }
};
exports.PermissionRelationsResolver = PermissionRelationsResolver;
__decorate([
    ...
    __metadata("design:paramtypes", [Permission_1.Permission, Object, Object, DataLoader]),
    __metadata("design:returntype", Promise)
], PermissionRelationsResolver.prototype, "RolePermissions", null);
exports.PermissionRelationsResolver = PermissionRelationsResolver = __decorate([
    (0, graphql_1.Resolver)(_of => Permission_1.Permission)
], PermissionRelationsResolver);
//# sourceMappingURL=PermissionRelationsResolver.js.map